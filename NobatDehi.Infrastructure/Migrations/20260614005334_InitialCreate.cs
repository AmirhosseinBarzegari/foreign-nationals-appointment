        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxDuplicateCount = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlanDependencies", x => x.Id);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PlanDependencies_Plans_RequiredPlanId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ForeignerCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Holidays_Offices_OfficeId",
                        column: x => x.OfficeId,
                        principalTable: "Offices",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Holidays_Provinces_ProvinceId",
                        column: x => x.ProvinceId,
                        principalTable: "Provinces",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OfficeHolidayExceptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OfficeHolidayExceptions_Holidays_HolidayId",
                        column: x => x.HolidayId,
                        principalTable: "Holidays",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OfficeHolidayExceptions_Offices_OfficeId",
                        column: x => x.OfficeId,
                        principalTable: "Offices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Holidays_OfficeId",
                table: "Holidays",
                column: "OfficeId");

            migrationBuilder.CreateIndex(
                name: "IX_Holidays_ProvinceId",
                table: "Holidays",
                column: "ProvinceId");

            migrationBuilder.CreateIndex(
                name: "IX_OfficeHolidayExceptions_HolidayId",
                table: "OfficeHolidayExceptions",
                column: "HolidayId");

            migrationBuilder.CreateIndex(
                name: "IX_OfficeHolidayExceptions_OfficeId",
                table: "OfficeHolidayExceptions",
                column: "OfficeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlanDependencies_RequiredPlanId",
                table: "PlanDependencies",
